...
namespace IV.BaseUnity
{
	public class SetPivotWindow : EditorWindow
	{
		...
		public static bool SaveMeshToFbxFolder
		{
		...
		[MenuItem("Window/Set Pivot")] 
		[MenuItem("Tools/Pivot Editor/Set Pivot")] 
		static void Init()
		{
		...
		void MeshClonningGUI()
		{
			...
			EditorGUILayout.LabelField("Mesh Cloning", EditorStyles.toolbarButton);
